...
```text
  ✓  npm publish WILL run for this push.
    Packages to bump: @notionx/create-notionx-app (0.7.0 → ?)
    ...
```
或
```text
  ✗  npm publish will NOT run for this push.
    Code changed in: @notionx/create-notionx-app (5 files)
...
```md
---
"@notionx/create-notionx-app": minor
---
...
npm view @notionx/create-notionx-app version
