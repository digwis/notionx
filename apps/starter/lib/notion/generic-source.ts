...
async function createDefaultGenericSource<TFields extends NotionFieldMap>(
  model: ContentModelDefinition<TFields>
) {
...
export async function listGenericNotionContent<TFields extends NotionFieldMap>(
  model: ContentModelDefinition<TFields>
) {
...
export async function getGenericNotionContentBySlug<
  TFields extends NotionFieldMap,
>(model: ContentModelDefinition<TFields>, slug: string) {
  const source = await sourceCache(model);
