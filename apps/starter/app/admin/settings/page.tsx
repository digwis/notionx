  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <form action={saveSiteTitleAction} className="flex items-end gap-3">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <form action={saveGoogleSettingsAction} className="space-y-4">
          ...
          {s.google_enabled === 1 && (
            <form action={disableGoogleSettingsAction}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <form action={saveTurnstileSettingsAction} className="space-y-4">
            <div className="space-y-2">
          ...
          {s.turnstile_enabled === 1 && (
            <form action={disableTurnstileSettingsAction}>
              <Button type="submit" variant="outline">
                <Power className="mr-1 h-4 w-4" />
                关闭 Turnstile
              </Button>
