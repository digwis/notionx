...
function capabilityBadges(model: ReturnType<typeof getContentModelAdminSummaries>[number]) {
  return [
...
export default function AdminContentModelsPage() {
  const models = getContentModelAdminSummaries();
              ...
              <TableBody>
                {models.map((model) => (
                  <TableRow key={model.id}>
                    ...
                    <TableCell>
                      <Badge variant={statusVariant(model.visibility)}>
                        {model.visibility}
                      </Badge>
                    </TableCell>
                    <TableCell>
