...
- Upgrading `@nextion/core`: [`docs/architecture/upgrading-nextion.md`](docs/architecture/upgrading-nextion.md)
...
```text
packages/nextion/        # Compiled and published as @nextion/core
apps/moviebluebook/         # Reference business app (consumes @nextion/core)
...
```bash
pnpm install
pnpm --filter @nextion/core build
...
```bash
pnpm -r test
pnpm --filter @nextion/core nextion:doctor
```
