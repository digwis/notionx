// packages/notionx-cli/src/prompt.ts
//
// Interactive prompt for `@notionx/cli`. The flow is intentionally
...
export interface Answers {
   ...
   * generated `package.json`. Default: `"^3.0.0"` (the version
   * published to npm). When developing inside the vinext monorepo,
   * pass `--notionx-source workspace:*` (or `link:…` / `file:…`)
...
export async function prompt(
  ...
  p.intro("@notionx/cli — scaffold a new Notionx project");
  ...
  return {
    starter: DEFAULT_ANSWERS.starter,
